        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="card text-center">
                    <div class="card-body">
                        <h5 class="card-title">Ajout d'un type d'employé</h5>
                        <br>
                        <form method="POST" action="controller/type/insert_type.php">
                            <div class="form-group">
                                <div class="row">
                                    <input type="text" class="form-control w-50 col-md-6 offset-md-3 " id="exampleInputEmail1" name="name" placeholder="Veuillez entrer le nom du type">
                                </div>
                                <br>
