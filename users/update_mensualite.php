...
$request = $bdd->query('SELECT * FROM type_employe');
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right user-dd animated">
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="../connexion/deconnexion.php"><i class="fa fa-power-off m-r-5 m-l-5"></i> Déconnexion</a>                            <div class="dropdown-divider"></div>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Espace Chef Département</h4>
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <a class="btn btn-success" href="mensualite_list.php">Retourner vers la Liste des mensualite</a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                ...
                <div class="card text-center">
                    <div class="card-body">
                        <h5 class="card-title">Formulaire de modification de mensualite</h5>
                        <br>
                        <form method="POST" action="controller/mensualite/update.php?id=<?= $_GET['id'] ?>">
                            <div class="form-group">

                                <label for="">Mensualité</label>
                                <input type="number" class="form-control w-50 col-md-6 offset-md-3 " id="exampleInputEmail1" value="<?= $_GET['mensualite'] ?>" name="mensualite" placeholder="Veuillez entrer un montant">

                                <br>
                                <label for="">Type d'employé</label>
                                <select class="form-control w-50 col-md-6 offset-md-3" name="type_employe_id" id="">
                                ...
                                <input type="number" min="1900" max="2030" value="<?= $_GET['annee'] ?>" name="annee" class="form-control <-50 col-md-6 offset-md-3">
                                <br>
