...
$reponse = $bdd->prepare('SELECT * FROM prets INNER JOIN type_employe ON prets.type_employe_id = type_employe.type_employe_id');
$reponse->execute();
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Liste des prets</h5>
                        
                        <div class="ml-auto text-right">
                        <a href="create_pret.php" class="btn btn-primary">Ajouter un pret</a>
                        </div> 
                        <br>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($donnees as $k) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="w-25">
                                                <div class="row">
                                                <a href="update_pret.php?id=<?= $k['pret_id'] ?>&montant=<?= $k['montant'] ?>" class="btn btn-success mr-2">Modifier</a>
                                                <form action="controller/pret/delete.php" class="delete" method="POST">
                                                    <input type="hidden" value="<?= $k['pret_id'] ?>" name="id">
