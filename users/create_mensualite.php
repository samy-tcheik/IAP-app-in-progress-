    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                ...
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                    <a href="mensualite_list.php" class="btn btn-success">Retour vers la liste des mensualite</a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                ...
                <div class="card text-center">
                    <div class="card-body">
                        <h5 class="card-title">Formulaire d'ajout d'une mensualité</h5>
                        <br>
                        <form method="POST" action="controller/mensualite/create.php">
                            <div class="form-group">

                                <label for="">Mensualité</label>
                                <input type="number" class="form-control w-50 col-md-6 offset-md-3 " id="exampleInputEmail1" name="mensualite" placeholder="Veuillez entrer un montant">
                                ...
                                <input type="number" min="1900" max="2030" value="2019" name="annee" class="form-control <-50 col-md-6 offset-md-3">
                                <br>
