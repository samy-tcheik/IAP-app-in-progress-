...
$reponse = $bdd->prepare('SELECT * FROM mensualite INNER JOIN type_employe ON mensualite.type_employe_id = type_employe.type_employe_id');
$reponse->execute();
...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Liste des mensualités</h5>
                        <div class="ml-auto text-right">
                            <a href="create_mensualite.php" class="btn btn-primary">Ajouter une mensualité</a>
                        </div>
                        <br>
                            ...
                            <table id="zero_config" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($donnees as $k) { ?>
                                        ...
                                        <tr>
                                            <td><?= $k['mensualite_id'] ?></td>
                                            <td><?= $k['mensualite'] ?></td>
                                            <td><?= $k['name']?></td>
                                            <td><?= $k['annee']?></td>
                                            <td class="w-25">
                                                <div class="row">
                                                <a href="update_mensualite.php?id=<?= $k['mensualite_id'] ?>&annee=<?= $k['annee'] ?>&mensualite=<?= $k['mensualite'] ?>" class="btn btn-success mr-2">Modifier</a>
                                                <form action="controller/mensualite/delete.php" method="POST" class="delete">
                                                <input type="hidden" value="<?= $k['mensualite_id'] ?>" name="id">
    ...
    <script>
        ...
        function swalFunction(event) {
            ...
            Swal.fire({
                title: 'Attention',
                text: "Vous etes sur de vouloir supprimer l'element ?",
                icon: 'warning',
