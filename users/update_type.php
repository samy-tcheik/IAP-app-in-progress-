...
$request = $bdd->query('SELECT name FROM type_employe WHERE type_employe_id = ' . $_GET['id'] . '');
$data = $request->fetch();
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                ...
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <a class="btn btn-success" href="type_employe_list.php">Retourner vers la Liste des type</a></div>
                </div>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                ...
                <div class="card text-center">
                    <div class="card-body">
                        <h5 class="card-title">Modifier le type d'employé</h5>
                        <br>
                        <form method="POST" action="controller/type/update.php?id=<?= $_GET['id'] ?>">
                            <div class="form-group">
                                <div class="row">
                                    <input type="text" value="<?= $data['name'] ?>" class="form-control w-50 col-md-6 offset-md-3 " id="exampleInputEmail1" name="name" placeholder="Veuillez entrer le nom du type">
                                </div>
                                <br>
