     ...
     <div id="main-wrapper">
         ...
         <div class="page-wrapper">
             ...
             <div class="container-fluid">
                 <h1 style="color:#000000  ;margin-left:150px ">Bienvenue dans votre espace chef département</h1>
                 </br>
                 </br>
                 <!-- ============================================================== -->
                 <!-- Sales Cards  -->
                 ...
                 <div class="row">
                     ...
                     <div class="col-md-6 col-lg-3 col-xlg-3">
                         <a href="type_employe_list.php">
                             <div class="card card-hover">
                                 <div class="box bg-success text-center">
                                     <h1 class="font-light text-white"><i class="mdi mdi-account-multiple"></i></h1>
                                     <h6 class="text-white">Liste des types Employés</h6>
                                 </div>
                             </div>
                         </a>
                     </div>
                         ...
                         <a href="type_employe_list.php">
                             <div class="card card-hover">
                                 <div class="box bg-warning text-center">
                                     ...
                                     <h6 class="text-white">Liste des mentualités par type d'employé</h6>
                                 </div>
                             </div>
                         </a>
                     </div>
                     <!-- Column -->
                     <div class="col-md-6 col-lg-3 col-xlg-3">
                         <a href="prets_list.php">
                             <div class="card card-hover">
                                 <div class="box bg-danger text-center">
                                     <h1 class="font-light text-white"><i class="mdi mdi-cash-multiple"></i></h1>
                                     <h6 class="text-white">Liste des prets par type d'employé</h6>
                                 </div>
                             </div>
                         </a>
                     </div>
