    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                ...
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <a class="btn btn-success" href="prets_list.php">Retourner vers la Liste des prets</a>
                    </div>
                </div>
            </div>
            <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                ...
                <div class="card text-center">
                    <div class="card-body">
                        <h5 class="card-title">Formulaire de modification du pret</h5>
                        <br>
                        <form method="POST" action="controller/pret/update.php?id=<?= $_GET['id'] ?>">
                            <div class="form-group">

                                <label for="">Montant du pret</label>
                                <input type="number" class="form-control w-50 col-md-6 offset-md-3 " id="exampleInputEmail1" name="montant" placeholder="Veuillez entrer un montant" value="<?= $_GET['montant'] ?>">
