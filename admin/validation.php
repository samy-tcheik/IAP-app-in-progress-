...
<![endif]-->
 ...
 <body>
                                 ...
                                 <tbody>
                                     ...
                                     <?php foreach ($donnees as $k) { ?>
                                         ...
                                         <tr>
                                             ...
                                             <td>
                                                 <form action="controllers/validate.php" method="POST" class ="validation">
                                                     <input type="hidden" name="id" value="<?= $k['id'] ?>">
                                                     <input type="checkbox" value="<?= $k['validation'] ?>" name="validation" onchange="submit()" data-on="Valider" data-off="Dévalider" class="switch" data-toggle="toggle">
                                                 </form>
                                             </td>
                                         </tr>
                                 </tbody>
     ...
     <script>
        ...
        function submit(){
            document.getElementByClassName('validation').submit();
        };
