<?php
    ...
    $query = $bdd->query('SELECT * FROM clients JOIN prets ON clients.type_employe_id = prets.type_employe_id JOIN mensualite ON clients.type_employe_id = mensualite.type_employe_id GROUP BY clients.id');
                                 ...
                                 <tbody>
                                     ...
                                     <?php foreach ($donnees as $k) { ?>
                                         ...
                                         <tr>
                                             ...
                                             <td>
                                                 <form action="controllers/delete.php" method="POST" class="delete">
