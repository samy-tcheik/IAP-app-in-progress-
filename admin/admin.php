    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <h1 style="color:#000000  ;margin-left:150px ">Bienvenue dans votre espace administrateur</h1>
            </br>
        </br>
                <!-- ============================================================== -->
                <!-- Sales Cards  -->
                    ...
                    <div class="col-md-6 col-lg-3 col-xlg-3">
                        ...
                        <div class="card card-hover">
                            <div class="box bg-success text-center">
                                ...
                                <h6 class="text-white">Ajouter des prêts</h6>
                            </div>
                        </div>
                    </a>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        ...
                        <div class="card card-hover">
                            <div class="box bg-warning text-center">
                                <h1 class="font-light text-white"><i class="mdi mdi-delete"></i></h1>
                                <h6 class="text-white">Supprimer des prêts</h6>
                            </div>
                        </div>
                    </a>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        ...
                        <div class="card card-hover">
                            <div class="box bg-danger text-center">
                                <h1 class="font-light text-white"><i class="mdi mdi-message-draw"></i></h1>
                                <h6 class="text-white">Modifier des prêts</h6>
                            </div>
                        </div>
                    </a>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3 col-xlg-3">
                        ...
                        <div class="card card-hover">
                            <div class="box bg-danger text-center">
                                ...
                                <h6 class="text-white">Consulter les prêts</h6>
                            </div>
                        </div>
                    </a>
                    </div>
