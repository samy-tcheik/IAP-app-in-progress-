                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" placeholder="Saisie le matricule" id="matricule" name="matricule" class="form-control" required="required">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" placeholder=" Saisie le nom" id="nom" name="nom" class="form-control" required="required">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" placeholder="Saisie le prénom" id="prenom" name="prenom" class="form-control" required="required">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" class="form-control" placeholder=" Siasie l'émail" required="required">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="password" id="password" name="password" placeholder="Saisie le mot de passe" class="form-control" required="required">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="number" id="numero" name="numero" class="form-control" placeholder="Saisie numéro de permis" required="required">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="structure" name="structure" class="form-control" placeholder="Saisie la structure" required="required">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <!--<input type="text" id="fonction" name="fonction" class="form-control" placeholder="Saisie la fonction" required="required">
                          -->
